...
class Loan(db.Model):
    ...
    def __init__(self, customer_name, book_name, loan_date, return_date, original_author, original_year_published, original_book_type):
        self.customer_name = XSSValidator.validate_xss(customer_name)
        self.book_name = XSSValidator.validate_xss(book_name)
        self.loan_date = loan_date
        self.return_date = return_date
        self.original_author = XSSValidator.validate_xss(original_author)
        self.original_year_published = original_year_published
        self.original_book_type = XSSValidator.validate_xss(original_book_type)
